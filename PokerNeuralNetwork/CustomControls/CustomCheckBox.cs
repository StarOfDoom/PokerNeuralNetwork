...
namespace PokerNeuralNetwork {
    ...
    public class CustomCheckBox : CheckBox {
        ...
        public void Loaded() {
            ...
            Stream myStream = myAssembly.GetManifestResourceStream("PokerNeuralNetwork.Resources.Plus.png");
            images[0] = new Bitmap(myStream);

            myStream = myAssembly.GetManifestResourceStream("PokerNeuralNetwork.Resources.Check.png");
